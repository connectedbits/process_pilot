...
module NextStep
  ...
  class ScriptTaskRunner < ServiceTaskRunner
    ...
    def call
      ...
      result = NextStep::Services::ExpressionEvaluator.call(expression: script, variables: variables)
      execution.signal(result)
    end
  end
  ...
  class BusinessRuleTaskRunner < TaskRunner
    ...
    def call
      ...
      result = NextStep::Services::DecisionEvaluator.call(decision_id, source, variables)
      execution.signal(result)
    end
  end
end
