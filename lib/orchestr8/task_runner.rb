...
module Orchestr8
  ...
  class ScriptTaskRunner < ServiceTaskRunner
    ...
    def call
      ...
      result = Orchestr8::Services::ExpressionEvaluator.call(expression: script, variables: variables)
      execution.signal(result)
    end
  end
  ...
  class BusinessRuleTaskRunner < TaskRunner
    ...
    def call
      ...
      result = Orchestr8::Services::DecisionEvaluator.call(decision_id, source, variables)
      execution.signal(result)
    end
  end
end
