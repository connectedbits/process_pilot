require_relative "lib/next_step/version"
...
Gem::Specification.new do |spec|
  ...
  spec.summary     = "Next Step"
  spec.description = "Next Step is a BPMN/DMN workflow gem for Rails apps."
  spec.license     = "MIT"

  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = "https://github.com/connectedbits/next_step"
