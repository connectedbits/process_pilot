require_relative "lib/orchestr8/version"

Gem::Specification.new do |spec|
  spec.name        = "orchestr8"
  spec.version     = Orchestr8::VERSION
  spec.authors     = ["Connected Bits"]
  spec.email       = ["info@connectedbits.com"]
  spec.homepage    = "https://www.connectedbits.com"
  spec.summary     = "Orchestr8"
  spec.description = "Orchestr8 is a BPMN/DMN workflow gem for Rails apps."
  spec.license     = "MIT"

  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = "https://github.com/connectedbits/orchestr8"
