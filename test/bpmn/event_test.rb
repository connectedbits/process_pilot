...
module Bpmn
  describe StartEvent do
    ...
    describe :execution do
      ...
      before { @process = Processable::Execution.start(context: context, process_id: "StartEventTest") }
  ...
  describe IntermediateThrowEvent do
    ...
    describe :execution do
      ...
      before { @process = Processable::Execution.start(context: context, process_id: "IntermediateThrowEventTest") }
  ...
  describe EndEvent do
    ...
    describe :execution do
      ...
      before { @process = Processable::Execution.start(context: context, process_id: "EndEventTest") }
