...
module Bpmn
  ...
  describe ExclusiveGateway do
    ...
    describe :execution do
      ...
      describe :happy_path do
        before { @process = Processable::Execution.start(context: context, process_id: "ExclusiveGatewayTest", variables: { action: "ok" }) }
      ...
      describe :default_path do
        before { @process = Processable::Execution.start(context: context, process_id: "ExclusiveGatewayTest", variables: { action: "¯\_(ツ)_/¯" }) }
  ...
  describe EventBasedGateway do
    ...
    describe :execution do
      ...
      before { @process = Processable::Execution.start(context: context, process_id: "EventBasedGatewayTest") }
  ...
  describe InclusiveGateway do
    ...
    describe :execution do
      ...
      before { @process = Processable::Execution.start(context: context, process_id: "InclusiveGatewayTest") }
