  ...
  module Bpmn
    describe ErrorEventDefinition do
      ...
      describe :execution do
        ...
        before { @process = NextStep.new(source).start(variables: { simulate_error: true }) }
    ...
    describe MessageEventDefinition do
      ...
      describe :execution do
        ...
        describe :start do
          ...
          before { @processes = NextStep.new(source).start_with_message(message_name: message_name) }
