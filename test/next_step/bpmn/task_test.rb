  ...
  module Bpmn
    ...
    describe Task do
      ...
      describe :execution do
        ...
        before { @process = NextStep.new(source).start }
    ...
    describe ServiceTask do
      ...
      describe :execution do
        ...
        before { @process = NextStep.new(source).start(variables: { name: "Eric" }) }
    ...
    describe BusinessRuleTask do
      ...
      let(:context) { NextStep.new([bpmn_source, dmn_source]) }
      ...
      describe :execution do
        ...
        before { @process = NextStep.new([bpmn_source, dmn_source]).start(variables: { season: "Spring", guests: 7 }) }
